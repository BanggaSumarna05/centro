...
export default function FloatingWhatsApp() {
  return (
    <motion.a
      ...
      className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-50 bg-[#25D366] text-white p-3.5 sm:p-4 rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.35)] flex items-center justify-center"
